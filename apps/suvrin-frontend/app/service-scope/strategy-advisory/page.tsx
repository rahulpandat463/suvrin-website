...
export const metadata: Metadata = {
  ...
  description:
    "AI Strategy That Starts with Your Business, Not the Technology. We help you build a practical AI roadmap.",
};
      ...
      <section className="py-20 bg-[#fafafa]">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="mt-16 text-center">
            <button className="bg-[#0546e0] text-white px-8 py-3.5 rounded-full font-semibold hover:bg-[#0437b0] transition-colors">
