...
export default function CategoryHero({ category, description }: CategoryHeroProps) {
  return (
    <div className="pt-32 px-6 lg:px-10 pb-8 bg-[#fbfbfb]">
      <section className="mx-auto max-w-[1240px] w-full" id="category-hero">

        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-8">
          {/* Left Card: Focus on the specific service */}
          <div className="bg-white rounded-[32px] p-10 md:p-14 lg:p-20 flex flex-col justify-center min-h-[450px] shadow-[0_4px_30px_rgba(0,0,0,0.03)] border border-black/[0.02] relative overflow-hidden group">
            {/* Background Accent */}
            ...
            <h1 className="text-[clamp(2.8rem,5vw,4.2rem)] tracking-tight text-[#111] leading-[1.05] mb-8 font-serif relative z-10">
              {category} <br />
              <span className="text-[#ef652a]">Specialization</span>
            </h1>
            
            <p className="text-[1.2rem] text-[#444] leading-relaxed mb-12 max-w-[550px] font-sans relative z-10">
              {description}
            </p>
            ...
            <div className="relative z-10">
              <Link
                href="/contact"
                className="inline-flex items-center gap-3 px-10 py-4.5 text-[0.95rem] font-bold text-white bg-[#111] rounded-full transition-all duration-300 hover:bg-[#ef652a] hover:shadow-[0_8px_24px_rgba(239,101,42,0.2)]"
              >
