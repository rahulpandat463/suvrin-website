      ...
      <div className="max-w-[1240px] w-full mx-auto px-6">
        <div className="relative w-full rounded-[32px] overflow-hidden bg-gradient-to-br from-[#1e60f2] via-[#2a70ff] to-[#4b8aff] pt-24 pb-16 px-6 flex flex-col items-center justify-center text-center shadow-[0_20px_60px_-15px_rgba(30,96,242,0.3)]">
          ...
          <div className="relative z-10 flex flex-col items-center gap-10 max-w-[800px]">
            <h2 className="text-[clamp(1.8rem,6vw,4.2rem)] font-serif tracking-tight leading-[1.05] text-white">
              Let's shape your <br /> AI strategy together
            </h2>

            <Link
              href="/contact"
              className="bg-[#0b3dc1] hover:bg-[#0932a1] transition-all duration-300 text-white px-10 py-4 rounded-full font-semibold text-[1rem] shadow-2xl hover:-translate-y-1"
            >
            ...
            <div className="mt-4 flex flex-col items-center gap-4">
              <div className="flex items-center -space-x-4">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full border-[3px] border-white overflow-hidden shadow-lg z-[3]">
                  <img
                ...
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border-[3px] border-white overflow-hidden shadow-xl z-[4] md:scale-110">
                  <img
