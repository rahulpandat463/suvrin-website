...
const logos = [
  { src: "/DLF_logo.png", alt: "DLF", scale: 1.65 },
  ...
  { src: "/Ezma.png", alt: "EZMA", scale: 0.8 },
            ...
            {displayLogos.map((logo, index) => (
              ...
              >
                <img
                  ...
                  className={`h-9 w-auto object-contain shrink-0 cursor-pointer transition-all duration-300 opacity-60 mix-blend-multiply grayscale hover:grayscale-0 ${
                    logo.alt === "FICCI" ? "contrast-200 brightness-125" : ""
                  }`}
                />
              </div>
            ))}
